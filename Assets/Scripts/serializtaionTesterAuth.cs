...
public class serializtaionTesterAuth : MonoBehaviour, IConvertGameObjectToEntity
{
    ...
    public void Convert(Entity entity, EntityManager dstManager, GameObjectConversionSystem conversionSystem)
    {
        ...
        var randFloat = Random.Range(0, 10900);
        var randInt1 = Random.Range(0, 10100);
        var randInt2 = Random.Range(0, 10090);
